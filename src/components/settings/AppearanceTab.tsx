...
export const AppearanceTab: React.FC<AppearanceTabProps> = ({
  ...
  return (
    <SettingsContainer style={previewStyles}>
      {/* Background + Theme color — preview kept, styling converged to the card standard */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-5">
          ...
          <div className="group">
            <div className="flex justify-between mb-1.5 px-1">
              ...
              <span className="text-[10px] text-primary font-mono font-bold surface-active px-1.5 py-0.5 rounded leading-none">
                {colsInput}
              </span>
            </div>
            <input
          ...
          <div className="group md:col-span-2 space-y-2.5">
            <div className="flex justify-between px-1">
              ...
              <div className="flex items-center gap-3">
                <div className="w-24 h-1.5 surface-active rounded-full overflow-hidden">
                  <div
                    className="h-full bg-[var(--theme-primary)] transition-all duration-300"
                    style={{ width: `${opacityInput * 100}%` }}
                  />
                </div>
                <span className="text-[10px] text-primary font-mono font-bold min-w-[32px] text-right">
